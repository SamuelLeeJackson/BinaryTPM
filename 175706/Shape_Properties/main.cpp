...
const int ASTNUMVTX = 1026;												// Number of shape model vertices
const int ASTNUMFACE = 2048;											// Number of shape model facets
string filename = "1996FG3_primary";											// Shape model input file name
