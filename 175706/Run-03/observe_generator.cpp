...
double hel_polar0 = 1.259034;											// Heliocentric distance in AU of asteroid position
double hel_polar1 = ((-1.8002/180.0)*PI);								// Heliocentric ecliptic latitude in radians of asteroid position
double hel_polar2 = ((184.3755/180.0)*PI);								// Heliocentric ecliptic longitude in radians of asteroid position 
double obs_polar0 = 0.773389;											// Geocentric distance in AU of asteroid position
double obs_polar1 = ((-2.932057/180.0)*PI);								// Geocentric ecliptic latitude in radians of asteroid position
double obs_polar2 = ((236.378553/180.0)*PI);								// Geocentric ecliptic longitude in radians of asteroid position
...
int observation_set_number = 3;										// Data set number (start at 0 and increment for each unique observation geometry/set)
