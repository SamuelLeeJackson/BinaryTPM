...
const int num_lightcurves = 4;										// Number of data sets
const int num_wavelengths[num_lightcurves] = {3,3,3,3};				// Number of wavelengths in each data set
const int num_data_points = 106;									// Total number of data points
