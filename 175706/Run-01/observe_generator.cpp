...
double hel_polar0 = 1.149516;											// Heliocentric distance in AU of asteroid position
double hel_polar1 = ((1.0595/180.0)*PI);								// Heliocentric ecliptic latitude in radians of asteroid position
double hel_polar2 = ((87.6639/180.0)*PI);								// Heliocentric ecliptic longitude in radians of asteroid position 
double obs_polar0 = 0.595065;											// Geocentric distance in AU of asteroid position
double obs_polar1 = ((2.050070/180.0)*PI);								// Geocentric ecliptic latitude in radians of asteroid position
double obs_polar2 = ((147.127494/180.0)*PI);								// Geocentric ecliptic longitude in radians of asteroid position
...
int observation_set_number = 1;										// Data set number (start at 0 and increment for each unique observation geometry/set)
