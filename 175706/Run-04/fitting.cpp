...
const int num_lightcurves = 5;										// Number of data sets
const int num_wavelengths[num_lightcurves] = {3,3,3,3,3};				// Number of wavelengths in each data set
const int num_data_points = 132;									// Total number of data points
...
string obs_data_file = "175706-combined";								// Data input file name
