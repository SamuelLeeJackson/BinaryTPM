...
double hel_polar0 = 1.219839;											// Heliocentric distance in AU of asteroid position
double hel_polar1 = ((-1.8739/180.0)*PI);								// Heliocentric ecliptic latitude in radians of asteroid position
double hel_polar2 = ((190.1486/180.0)*PI);								// Heliocentric ecliptic longitude in radians of asteroid position 
double obs_polar0 = 0.611435;											// Geocentric distance in AU of asteroid position
double obs_polar1 = ((-3.741913/180.0)*PI);								// Geocentric ecliptic latitude in radians of asteroid position
double obs_polar2 = ((134.857558/180.0)*PI);								// Geocentric ecliptic longitude in radians of asteroid position
...
int main() {
	...
	string status_filename=shape_filename+"_observe_status.txt";
