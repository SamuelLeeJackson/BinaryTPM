...
double rot0 = ((69.0 / 180.0) * PI);										// Heliocentric ecliptic latitude in radians of asteroid rotation pole
double rot1 = ((210.0 / 180.0) * PI);									// Heliocentric ecliptic longitude in radians of asteroid rotation pole
...
float maximum_thermal_inertia = 300.0f;								// Maximum thermal inertia value to run model for (set to minimum thermal inertia value if you want to run for a single and fixed thermal inertia value)
