...
double rot0 = ((65.0 / 180.0) * PI);										// Heliocentric ecliptic latitude in radians of asteroid rotation pole
double rot1 = ((215.0 / 180.0) * PI);									// Heliocentric ecliptic longitude in radians of asteroid rotation pole
...
const int num_threads = 40;											// Number of parallel threads to use
